...
export const notifications: Notification[] = [
  { id: "notif-1", title: "Policy conflict detected", description: "Three HR sources disagree on casual leave entitlement. Visible to everyone.", type: "conflict", read: false, timestamp: new Date(Date.now() - 3600000 * 2), actionUrl: "/conflicts" },
...
export const intelligenceFeed: IntelligenceEvent[] = [
  { id: "ie-1", type: "conflict", severity: "high", title: "Casual leave conflict detected", description: "HR Handbook, Leave Policy, and Manager Guide prescribe 10, 12, and 15 days. Review required.", source: "HR Policy Auditor", timestamp: new Date(Date.now() - 3600000 * 2), actionLabel: "Review Conflict", actionUrl: "/conflicts" },
  ...
  { id: "ie-6", type: "conflict", severity: "medium", title: "Vendor liability cap discrepancy", description: "Master Agreement and Risk Assessment Matrix define different liability caps. Legal review needed.", source: "Contract Review Agent", timestamp: new Date(Date.now() - 86400000 * 1), actionLabel: "Compare Documents", actionUrl: "/conflicts" },
